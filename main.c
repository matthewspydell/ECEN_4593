...
int program1Memory[] = {0x00000bb8, //  $sp = 3000
    ...
    0x0f0f0000,
    0x0000e000};
int program2Memory[] = {0x00000898, // $sp = 2200
0x00000898, // $fp = 2200
...
size_t programLength1 = sizeof (program1Memory) / sizeof (uint32_t);
size_t programLength2 = sizeof (program2Memory) / sizeof (uint32_t);

int main() {

    //loadMemory(mainMemory, program1Memory, programLength1); // load program 1
    loadMemory(mainMemory, program2Memory, programLength2); // load program 2
    ...
    */
    ...
    printf("\nmainMemory[6] = 0x%x = %d\n", mainMemory[6], mainMemory[6]);
    printf("mainMemory[7] = 0x%x = %d\n", mainMemory[7], mainMemory[7]);
    printf("mainMemory[8] = 0x%x = %d\n", mainMemory[8], mainMemory[8]);
    printf("mainMemory[9] = 0x%x = %d\n", mainMemory[9], mainMemory[9]);
    printf("Clock Cycles = %d\n", clockCycles);
    for (int i = 0; i < 1200; i++) {
        printf("mainMemory[%d] = 0x%x = %u\n", i, mainMemory[i], mainMemory[i]);
    }
